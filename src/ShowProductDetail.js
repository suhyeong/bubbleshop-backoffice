                    ...
                    <Form id={'prd-detail-form'} form={form} onFinish={onSubmit} encType={"multipart/form-data"}>
                        <Card className='product-detail-card'
                            ...
                            {<Spin spinning={loading} tip="Loading" size="middle">
                                {activeTab === 'essentialInfo' ?
                                    (result && <ShowProductEssentialInfoDetail product={result} form={form} />)
                                    : (result && <ShowProductImageInfoDetail productImage={result.imageList} form={form}
                        ...
                        <div>
                            <div className="product-detail-bottom-parent">
                                <Button className='product-detail-modify-button' type="primary" htmlType={"submit"}>저장</Button>
